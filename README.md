...
## Web Application (ASP.NET Core Demo)

Простое веб-приложение, демонстрирующее работу **векторного поискового движка** через веб-интерфейс. Позволяет пользователю вводить текстовые запросы и получать отсортированный по релевантности список документов.

- Для демонстрации **интеграции поискового движка** в веб-систему.
- Для тестирования и визуализации результатов поиска.
- Как база для создания полноценного поискового интерфейса.