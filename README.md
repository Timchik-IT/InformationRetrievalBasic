...
Проект с второй домашней работой представляет из себя файл с методами обработки и токенизации текста из файлов скаченный страниц. 

- Получает путь к 100 файлам скаченных страниц.
- Обрабатывает текст удаляя из него дубликаты, союзы, предлоги, числа.
